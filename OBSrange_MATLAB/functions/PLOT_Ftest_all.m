...
plot(ax1,Xgrd(Iy_max,Ix_max,Iz_max),Ygrd(Iy_max,Ix_max,Iz_max),'ok','markerfacecolor',[1 0 0],'markersize',12,'linewidth',1)
...
plot(ax2,Xgrd(Iy_max,Ix_max,Iz_max),Zgrd(Iy_max,Ix_max,Iz_max),'ok','markerfacecolor',[1 0 0],'markersize',12,'linewidth',1)
...
plot(ax3,Ygrd(Iy_max,Ix_max,Iz_max),Zgrd(Iy_max,Ix_max,Iz_max),'ok','markerfacecolor',[1 0 0],'markersize',12,'linewidth',1)
